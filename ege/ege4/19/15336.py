def f19(s1, s2, step = 1): #1p 2v 3p 4v 5p
    if s1 + s2 >= 123 and step == 3:
        return True
    if ((s1 + s2 >= 123 and step != 3) or
         (s1 + s2 < 123 and step == 3)):
        return False
...
def f20(s1, s2, step = 1): #1p 2v 3p 4v 5p
    if s1 + s2 >= 123 and step == 4:
        return True
    if ((s1 + s2 >= 123 and step != 4) or
         (s1 + s2 < 123 and step == 4)):
        return False
...
def f21(s1, s2, step = 1): #1p 2v 3p 4v 5p
    if s1 + s2 >= 123 and step in (3, 5):
        return True
    if ((s1 + s2 >= 123 and step != 5) or
         (s1 + s2 < 123 and step == 5)):
        return False
